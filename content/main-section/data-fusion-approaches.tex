...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.80\textwidth]{images/data-fusion-union-results}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.80\textwidth]{images/data-fusion-highest-hit}
