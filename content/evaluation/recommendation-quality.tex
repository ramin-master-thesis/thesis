...
The hyperparameter tuning benchmark was done on a two-partition setting to keep the evaluation simple, t. The hyperparameter tuning experiments were structured in the following steps:
